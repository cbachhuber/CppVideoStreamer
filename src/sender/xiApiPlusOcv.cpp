...
XI_TEST_PATTERN_GENERATOR xiAPIplus_Camera::GetTestPatternGeneratorSelector_Maximum()
{
    ...
    CheckCamHandle(
        "GetTestPatternGeneratorSelector"
        "_Maximum");
...
int xiAPIplus_Camera::GetAutoExposureAutoGainROIHeight_Maximum()
{
    ...
    CheckCamHandle(
        "GetAutoExposureAutoGainROIHeight"
        "_Maximum");
...
XI_SENS_DEFFECTS_CORR_LIST_SELECTOR xiAPIplus_Camera::GetSensorDefectsCorrectionListSelector_Maximum()
{
    ...
    CheckCamHandle(
        "GetSensorDefectsCorrectionListSelector"
        "_Maximum");
...
void xiAPIplus_Camera::SetSensorDefectsCorrectionListSelector(
    XI_SENS_DEFFECTS_CORR_LIST_SELECTOR SensorDefectsCorrectionListSelector)
{

    CheckCamHandleInt("SetSensorDefectsCorrectionListSelector", (int)SensorDefectsCorrectionListSelector);

    XI_RETURN res =
        xiSetParamInt(camera_handle, XI_PRM_SENS_DEFECTS_CORR_LIST_SELECTOR, SensorDefectsCorrectionListSelector);
...
void xiAPIplus_Camera::SetSensDefectsCorrListContent(char* new_value)
{
    ...
    XI_RETURN res =
        xiSetParamString(camera_handle, XI_PRM_SENS_DEFECTS_CORR_LIST_CONTENT, new_value, (DWORD)strlen(new_value));
...
void xiAPIplus_Camera::SetFFCFlatFieldFileName(char* new_value)
{
    ...
    XI_RETURN res =
        xiSetParamString(camera_handle, XI_PRM_FFC_FLAT_FIELD_FILE_NAME, new_value, (DWORD)strlen(new_value));
...
void xiAPIplus_Camera::SetFFCDarkFieldFileName(char* new_value)
{
    ...
    XI_RETURN res =
        xiSetParamString(camera_handle, XI_PRM_FFC_DARK_FIELD_FILE_NAME, new_value, (DWORD)strlen(new_value));
...
// Vertical Decimation - vertical sub-sampling of the image - reduces the vertical resolution of the image by the
// specified vertical decimation factor. (XI_PRM_DECIMATION_VERTICAL)
...
// Horizontal Decimation - horizontal sub-sampling of the image - reduces the horizontal resolution of the image by the
// specified vertical decimation factor. (XI_PRM_DECIMATION_HORIZONTAL)
...
XI_DEC_PATTERN xiAPIplus_Camera::GetDecimationHorizontalPattern_Maximum()
{
    ...
    CheckCamHandle(
        "GetDecimationHorizontalPattern"
        "_Maximum");
...
float xiAPIplus_Camera::GetAutoExposureAutoGainExposurePriority_Maximum()
{
    ...
    CheckCamHandle(
        "GetAutoExposureAutoGainExposurePriority"
        "_Maximum");
...
int xiAPIplus_Camera::GetAutoExposureAutoGainTargetLevel_Maximum()
{
    ...
    CheckCamHandle(
        "GetAutoExposureAutoGainTargetLevel"
        "_Maximum");
...
// Device output data packing (or grouping) enabled. Packing could be enabled if output_data_bit_depth > 8 and packing
// capability is available. (XI_PRM_OUTPUT_DATA_PACKING)
...
XI_OUTPUT_DATA_PACKING_TYPE xiAPIplus_Camera::GetDeviceOutputDataPackingType_Maximum()
{
    ...
    CheckCamHandle(
        "GetDeviceOutputDataPackingType"
        "_Maximum");
...
// Sensor clock frequency index. Sensor with selected frequencies have possibility to set the frequency only by this
// index. (XI_PRM_SENSOR_CLOCK_FREQ_INDEX)
...
// Defines which source will be used for timestamp reset. Writing this parameter will trigger settings of engine
// (arming) (XI_PRM_TS_RST_SOURCE)
...
int xiAPIplus_Camera::GetAcquisitionBufferSizeBytesUnit_Maximum()
{
    ...
    CheckCamHandle(
        "GetAcquisitionBufferSizeBytesUnit"
        "_Maximum");
...
int xiAPIplus_Camera::GetAcquisitionTransportPacketSizeBytes_Maximum()
{
    ...
    CheckCamHandle(
        "GetAcquisitionTransportPacketSizeBytes"
        "_Maximum");
...
int xiAPIplus_Camera::GetAcquisitionQueueImagesCount_Maximum()
{
    ...
    CheckCamHandle(
        "GetAcquisitionQueueImagesCount"
        "_Maximum");
...
// Current sensor mode. Allows to select sensor mode by one integer. Setting of this parameter affects: image dimensions
// and downsampling. (XI_PRM_SENSOR_MODE)
...
xiapi_errorcode_t xiAPIplus_errorcodes_list[] = {
    ...
    XI_NOT_SUPPORTED,
    "Not supported",
    XI_ISOCH_ATTACH_BUFFERS,
    "Attach buffers error",
    XI_GET_OVERLAPPED_RESULT,
    "Overlapped result",
    XI_MEMORY_ALLOCATION,
    "Memory allocation error",
    XI_DLLCONTEXTISNULL,
    "DLL context is NULL",
    XI_DLLCONTEXTISNONZERO,
    ...
    XI_NOT_IMPLEMENTED,
    "Not implemented",
    XI_SHADING_TOOBRIGHT,
    "Shading is too bright",
    XI_SHADING_TOODARK,
    "Shading is too dark",
    XI_TOO_LOW_GAIN,
    "Gain is too low",
    XI_INVALID_BPL,
    "Invalid sensor defect correction list",
    XI_BPL_REALLOC,
    "Error while sensor defect correction list reallocation",
    XI_INVALID_PIXEL_LIST,
    "Invalid pixel list",
    XI_INVALID_FFS,
    "Invalid Flash File System",
    XI_INVALID_PROFILE,
    "Invalid profile",
    XI_INVALID_CALIBRATION,
    "Invalid calibration",
    XI_INVALID_BUFFER,
    "Invalid buffer",
    XI_INVALID_DATA,
    ...
    XI_ACQUISITION_ALREADY_UP,
    "Acquisition already started",
    XI_OLD_DRIVER_VERSION,
    ...
    XI_INVALID_OUTPUT_ICC_PROFILE,
    "Output ICC profile missing or corrupted",
    XI_DEVICE_NOT_READY,
    "Device not ready to operate",
    XI_SHADING_TOOCONTRAST,
    "Shading is too contrast",
    XI_ALREADY_INITIALIZED,
    "Module already initialized",
    XI_NOT_ENOUGH_PRIVILEGES,
    "Application does not have enough privileges (one or more app)",
    XI_NOT_COMPATIBLE_DRIVER,
    ...
    XI_NO_DEVICES_FOUND,
    "No Devices Found",
    XI_RESOURCE_OR_FUNCTION_LOCKED,
    "Resource (device) or function locked by mutex",
    XI_BUFFER_SIZE_TOO_SMALL,
    "Buffer provided by user is too small",
    XI_COULDNT_INIT_PROCESSOR,
    "Couldnt initialize processor.",
    XI_NOT_INITIALIZED,
    "The object/module/procedure/process being referred to has not been started.",
    XI_RESOURCE_NOT_FOUND,
    ...
    XI_NOT_SUPPORTED_PARAM,
    "Parameter is not supported",
    XI_NOT_SUPPORTED_PARAM_INFO,
    "Parameter info not supported",
    XI_NOT_SUPPORTED_DATA_FORMAT,
    "Data format is not supported",
    XI_READ_ONLY_PARAM,
    "Read only parameter",
    XI_BANDWIDTH_NOT_SUPPORTED,
    "This camera does not support currently available bandwidth",
    XI_INVALID_FFS_FILE_NAME,
    "FFS file selector is invalid or NULL",
    XI_FFS_FILE_NOT_FOUND,
    "FFS file not found",
    XI_PARAM_NOT_SETTABLE,
    "Parameter value cannot be set (might be out of range or invalid).",
    XI_SAFE_POLICY_NOT_SUPPORTED,
    "Safe buffer policy is not supported. E.g. when transport target is set to GPU (GPUDirect).",
    XI_GPUDIRECT_NOT_AVAILABLE,
    "GPUDirect is not available. E.g. platform isn't supported or CUDA toolkit isn't installed.",
    XI_PROC_OTHER_ERROR,
    "Processing error - other",
    XI_PROC_PROCESSING_ERROR,
    "Error while image processing.",
    XI_PROC_INPUT_FORMAT_UNSUPPORTED,
    "Input format is not supported for processing.",
    XI_PROC_OUTPUT_FORMAT_UNSUPPORTED,
...
unsigned long xiAPIplus::GetNumberOfConnectedCameras()
{
    ...
    if (res)
        ReportException(res, "GetNumberOfConnectedCameras");
    return count;
}
...
void xiAPIplus::EnableCamEnumGoldenEnabled()
{
    ...
    if (res)
        ReportException(res, "EnableCamEnumGoldenEnabled");
}
...
void xiAPIplus_Exception::GetDescription(char* name, size_t name_max_size)
{
    ...
    if (!description)
        return;
    if (name_max_size < sizeof(description))
        return;
...
void xiAPIplus_Camera::OpenByID(unsigned long id)
{
    ...
    if (!camera_handle)
        res = XI_INVALID_HANDLE;
    CheckResult(res, "OpenByID");
}
void xiAPIplus_Camera::OpenBySN(char* serial_number)
{
    if (!serial_number)
        ReportException(XI_WRONG_PARAM_VALUE, "xiAPIplus_Camera::OpenBySN()");
...
{
    if (!device_path)
        ReportException(XI_WRONG_PARAM_VALUE, "xiAPIplus_Camera::OpenByPath()");
...
{
    if (!user_id)
        ReportException(XI_WRONG_PARAM_VALUE, "xiAPIplus_Camera::OpenByUserID()");
...
{
    if (!location)
        ReportException(XI_WRONG_PARAM_VALUE, "xiAPIplus_Camera::OpenByLocation()");
...
void xiAPIplusCameraOcv::resetCvImage_()
{
    ...
    {
        if (((int)(next_image_->GetWidth() + next_image_->GetPadding_X()) != cv_image_->width) ||
            ((int)next_image_->GetHeight() != cv_image_->height))
            do_reset = true;
    }
    ...
    if (do_reset)
    {
        ...
        {
            case XI_MONO8:
                cv_image_ = cvCreateImage(
                    cvSize(next_image_->GetWidth() + next_image_->GetPadding_X(), next_image_->GetHeight()),
                    IPL_DEPTH_8U,
                    1);
                printf("Doing reset to mono\n");
                break;
            case XI_RAW8:
                cv_image_ = cvCreateImage(cvSize(next_image_->GetWidth(), next_image_->GetHeight()), IPL_DEPTH_8U, 1);
                printf("Doing reset to mono\n");
                break;
            case XI_MONO16:
            case XI_RAW16:
                cv_image_ = cvCreateImage(cvSize(next_image_->GetWidth(), next_image_->GetHeight()), IPL_DEPTH_16U, 1);
                printf("Doing reset to mono\n");
                break;
            case XI_RGB24:
            case XI_RGB_PLANAR:
                cv_image_ = cvCreateImage(cvSize(next_image_->GetWidth(), next_image_->GetHeight()), IPL_DEPTH_8U, 3);
                printf("Doing reset to RGB\n");
                ;
                break;
            case XI_RGB32:
                cv_image_ = cvCreateImage(cvSize(next_image_->GetWidth(), next_image_->GetHeight()), IPL_DEPTH_8U, 4);
                printf("Doing reset to RGB\n");
                ;
                break;
            default:
